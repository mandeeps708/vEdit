#############################################################################
# Makefile for building: vEdit
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  vEdit.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile vEdit.pro
#############################################################################
...
Makefile: vEdit.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/vEdit1.0.0 || mkdir -p .tmp/vEdit1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/vEdit1.0.0/ && $(COPY_FILE) --parents AppResources.qrc .tmp/vEdit1.0.0/ && $(COPY_FILE) --parents mainwindow.h .tmp/vEdit1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/vEdit1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/vEdit1.0.0/ && (cd `dirname .tmp/vEdit1.0.0` && $(TAR) vEdit1.0.0.tar vEdit1.0.0 && $(COMPRESS) vEdit1.0.0.tar) && $(MOVE) `dirname .tmp/vEdit1.0.0`/vEdit1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/vEdit1.0.0
...
qrc_AppResources.cpp: AppResources.qrc \
		...
		copy.png \
		Saveas.png
	/usr/lib/x86_64-linux-gnu/qt5/bin/rcc -name AppResources AppResources.qrc -o qrc_AppResources.cpp
